...
def get_avg(df: pd.DataFrame, year):
    ...
    column_avg = year_df.mean(skipna = True)
    # print(column_avg)
    return column_avg
...
def get_cumulative_ret(df):
    ...
    """
    # <COMPLETE THIS PART>
    df_cum = (df + 1).prod(axis=0, skipna=True) - 1
...
def t_stat(EW_LS_pf_df):
     """
    calculate the mean of 'ls' columns in EW_LS_pf_df,
    the t stat of 'ls' columns in EW_LS_pf_df,
    the number of observations of 'ls' columns in EW_LS_pf_df
    ...
    """
     statistic_dict = {"ls_bar": [EW_LS_pf_df['ls'].mean()],
                       "n_obs" :[EW_LS_pf_df['ls'].count()],
                       "ls_t": [EW_LS_pf_df['ls'].mean()/(EW_LS_pf_df['ls'].std()/math.sqrt(EW_LS_pf_df['ls'].count()))]}
     return pd.DataFrame.from_dict(statistic_dict)
...
if __name__ == "__main__":
    ...
    DM_Ret_dict,Vol_Ret_mrg_df,EW_LS_pf_df = portfolio_main(cfg.TICMAP.keys(), '2000-12-29', '2021-08-31', 'vol', ['Daily',], 3)
    #print(EW_LS_pf_df)
    # print(DM_Ret_dict)
    #q1,q2
    # k = get_avg(DM_Ret_dict['Daily'],2008)
    # print(k)
    # print(k.idxmin())
    # q3
    # k1 = get_avg(DM_Ret_dict['Monthly'],2019)
    # print(k1)
    # print(k1.idxmax())
    # q4
    # print(Vol_Ret_mrg_df)
    # k = get_avg(Vol_Ret_mrg_df['tsla_vol'],2010)
    # print(k)
    # q5
    # k1 = (get_avg(Vol_Ret_mrg_df['v_vol'],2018) - get_avg(Vol_Ret_mrg_df['v_vol'],2008))/get_avg(Vol_Ret_mrg_df['v_vol'],2008)
    # print(k1)
    # q7
    # tsla = Vol_Ret_mrg_df[['tsla','tsla_vol']]
    # tsla = tsla[tsla.index.year == 2010]
    # print(tsla)
    # tsla.dropna(how='any',inplace=True)
    # print(tsla.shape)
